    ...
    <div className="p-6 flex justify-between items-center fixed top-0 left-0 w-full z-[9999] bg-black shadow-lg border-b border-gray-800">
      ...
      <div className="flex items-center gap-14">
        ...
        <nav className="flex items-center gap-12 ml-auto">
          <Link
            to="/"
            className="text-white text-lg font-bold pb-1 hover:text-yellow-500 transition-all no-underline hover:scale-105 hover:opacity-80"
          >
            Trang Chủ
          </Link>
          <Link
      ...
      <div className="relative group">
        <a
          href="https://www.facebook.com/nguyen.inh.loc.490678"
          target="_blank"
